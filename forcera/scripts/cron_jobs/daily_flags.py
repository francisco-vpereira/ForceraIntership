...
# Nos passos seguintes, os contratos com flag ativada da tabela daily_flags serão atualizados
cur = conn.cursor()
for i,j in new_ids:
    cur.execute(''' INSERT INTO daily_flags(id, data_publicacao,"RF2", "RF3", "R003", "R017", "R018", "R019") 
...
cur.execute('''
            ...
            WHERE daily_flags."id" IN (
            	...
            	'''.format(lim_sup=lim_sup_mc, lim_inf=lim_inf_mc), (last_id,))
conn.commit() 
