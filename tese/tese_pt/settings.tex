...
\usepackage[portuguese]{babel}% The package manages culÂ­turÂ­ally-deÂ­terÂ­mined tyÂ­poÂ­graphÂ­iÂ­cal (and other) rules,
...
\usepackage{calc}		%Para poder fazer cÃ¡lculos de variÃ¡veis no codigo
...
\usepackage{caption}	%proÂ­vides many ways to cusÂ­tomise the capÂ­tions in floatÂ­ing enÂ­viÂ­ronÂ­ments
...
% ------------------------------------
%\input{settings/check-marks.tex}
% ------------------------------------
\input{settings/geometry.tex}
% ------------------------------------
%\usepackage[no-math]{fontspec}
%\input{settings/font-types.tex}
% ------------------------------------
%\input{settings/special-chars.tex}
% ------------------------------------
\input{settings/headers.tex}
% ------------------------------------
% \input{settings/idk.tex}
% ------------------------------------
\input{settings/font-sizes.tex}
% ------------------------------------
\input{settings/blank-pages.tex}
...
\usepackage{enumerate}% Para permitir enumeraÃ§Ãµes personalizadas i), a), 1), ...
...
\usepackage[figuresright]{rotating}       %Para permitir rotaÃ§Ã£o de tabelas e texto em tabelas
...
%\renewcommand{\thefootnote}{\arabic{footnote}}  %Para as notas de rodapÃ©
%\interfootnotelinepenalty=10000
%%%%\renewcommand{\thefootnote}{\fnsymbol{footnote}}
%%%%\renewcommand{\thefootnote}{\roman{footnote}}

%\usepackage{cancel}   			%para permitir rasuras nas formulas matemÃ¡ticas
\usepackage{gensymb}

%\input{settings/biblioset.tex}
...
\usepackage{hyperref}               %Para as hyperligaÃ§Ãµes ao longo do texto
...
\newcommand{\coloredmidrule}[1]{\arrayrulecolor{#1}\midrule[1.5px]\arrayrulecolor{gray}}
