...
De todas as colunas da tabela onde se encontram guardados os contratos, as que reveleram maior utilidade foram as seguintes : 
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lrr}
			...
			\multicolumn{1}{c}{\cellcolor[HTML]{C0C0C0}\textbf{Tipo de Procedimento}}      & \multicolumn{1}{c}{\cellcolor[HTML]{C0C0C0}\textbf{Número de Contratos}} & \multicolumn{1}{c}{\cellcolor[HTML]{C0C0C0}\textbf{\%}} \\ \hline
