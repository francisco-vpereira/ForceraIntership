...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lrr}
			...
			\multicolumn{1}{c}{\cellcolor[HTML]{C0C0C0}\textbf{Tipos de Procedimentos}}    & \multicolumn{1}{c}{\cellcolor[HTML]{C0C0C0}\textbf{Número de Contratos}} & \multicolumn{1}{c}{\cellcolor[HTML]{C0C0C0}\textbf{\%}} \\ \hline
