...
Da totalidade de Ajustes Diretos em Regime Geral presentes na base de dados, 14812(2.8\%) destes foram adjudicados com um valor superior ao permitido por lei. Destes, 12828(2.4\%) dizem respeito a contratos de Bens e Serviços e 1984(0.4\%) a contratos de Empreitadas.
...
\begin{table}[H]
	...
	\begin{tabular}{ccccc}
		\hline
		\textbf{Grupo CPV}   & \textbf{\begin{tabular}[c]{@{}c@{}}Número de contratos \\ inconformes ($N_1$)\end{tabular}} & \textbf{$\frac{N_1}{N_{Total}}$\%} & \textbf{\begin{tabular}[c]{@{}c@{}}Número de \\ contratos total ($N_2$)\end{tabular}} & \textbf{$\frac{N_1}{N_{2}}$\%} \\ \hline
		45                   & 6128                                                                                        & 22.5                               & 22371                                                                                 & 27.4                           \\
		33                   & 5446                                                                                        & 19.9                               & 30419                                                                                 & 17.9                           \\ \hline
		\textbf{Divisão CPV} & \textbf{\begin{tabular}[c]{@{}c@{}}Número de contratos \\ inconformes ($N_1$)\end{tabular}} & \textbf{$\frac{N_1}{N_{Total}}$\%} & \textbf{\begin{tabular}[c]{@{}c@{}}Número de \\ contratos total ($N_2$)\end{tabular}} & \textbf{$\frac{N_1}{N_{2}}$\%} \\ \hline
...
Foram detetados cerca de 20\% ($N_{Total} =$ 25274) concursos públicos em que apenas se candidatou uma entidade. Na Tabela \ref{tab:rf18stats} é percetível quais  as principais divisões de CPV onde se verifica esta inconformidade e respetivos valores.
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{cccccc}
			\hline
			\textbf{Divisão CPV} & \textbf{\begin{tabular}[c]{@{}c@{}}Número de contratos \\ inconformes ($N_1$)\end{tabular}} & \textbf{ $\frac{N_1}{N_{Total}}$\%} & \textbf{\begin{tabular}[c]{@{}c@{}}Número de \\ contratos total ($N_2$)\end{tabular}} & \textbf{ $\frac{N_1}{N_{2}}$\%} & \textbf{\begin{tabular}[c]{@{}c@{}}Preço contratual\\ total\end{tabular}} \\ \hline
...
Os resultados obtidos, que constam na seguinte Figura \ref{fig:necincump}, evidenciam uma forte predominância das divisões 33 e 45 do CPV. Foram detetados cerca de 18\% ($N_{Total} = 22951$) contratos cujo número de entidades concorrentes é considerado outlier. 
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{ccccccc}
			\hline
			\textbf{Divisão CPV} & \textbf{\begin{tabular}[c]{@{}c@{}}Número de contratos \\ inconformes ($N_1$)\end{tabular}} & \textbf{$\frac{N_1}{N_{Total}}$\%} & \textbf{\begin{tabular}[c]{@{}c@{}}\% Outliers\\ inferiores\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}\% Outliers \\ superiores\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Número de \\ contratos total ($N_2$)\end{tabular}} & \textbf{$\frac{N_2}{N_{Total}}$\%} \\ \hline
			33                   & 8182                                                                                        & 35.6                               & 88.7                                                                      & 11.3                                                                      & 29351                                                                                 & 27.8                               \\
			45                   & 6381                                                                                        & 27.8                               & 68.4                                                                      & 31.6                                                                       & 21525                                                                                 & 29.6                               \\ \hline
		\end{tabular}%
	}
	\caption{Descrição do número de contratos, total e inconformes, para as principais divisões de CPV.}
	\label{tab:rf19stats}
...
Dos outliers detetados, considerando apenas as divisões 33 e 45, constata-se que a maioria se posiciona abaixo da extremidade inferior, circunstância que remete para um elevado número de contratos celebrados com um número de entidades concorrentes reduzido.
...
Em suma, a deteção de contratos que obdecem às condições impostas por este indicador seguem o processo ilustrado na Figura \ref{fig:r31}. 
...
\begin{table}[H]
	...
	\begin{tabular}{cccc}
		\cline{2-4}
		& \textbf{\begin{tabular}[c]{@{}c@{}}Número de contratos celebrados, \\ por empresa, para grupo de CPV\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Número de contratos total\\ celebrados para grupo de CPV\end{tabular}} & \textbf{Rácio} \\ \hline
		\textbf{Empresa A} & 257                                                                                                                & \multirow{3}{*}{1564}                                                                                     & 0.16           \\
		\textbf{Empresa B} & 1271                                                                                                               &                                                                                                           & 0.81           \\
		\textbf{Empresa C} & 38                                                                                                                 &                                                                                                           & 0.03            \\ \hline
	\end{tabular}%
	}
...
Esta tabela é constituída pelo identificador do contrato, a data de publicação, uma coluna de verificação - cujo propósito irá ser clarificado nos próximos parágrafos - e as colunas referentes a cada uma das flags, cujo output é binário: \textit{true} ou \textit{false}. 
